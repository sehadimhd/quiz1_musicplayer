...
<html lang="en">
  ...
  <div class="row justify-content-center mt-5">
        <div class="col-md-5">
          <div class="card">
            <div class="card-header bg-transparent mb-0"><h5 class="text-center">Input Data Album</h5></div>
            <div class="card-body">
              <form action="AlbumInsertProcess" method="post">
