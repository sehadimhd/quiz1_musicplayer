...
<html lang="en">
  ...
  <div class="row justify-content-center mt-5">
        <div class="col-md-5">
          <div class="card">
            <div class="card-header bg-transparent mb-0"><h5 class="text-center">Input Data Artist</h5></div>
            <div class="card-body">
              <form action="ArtistInsertProcess" method="post">
                <div class="form-group">
                  <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                </div>
                <div class="form-group">
                  Nama Artist<br>
                  <input type="text" name="artist_name" class="form-control" placeholder="Nama Artist" required>
                </div>
                <div class="form-group">
