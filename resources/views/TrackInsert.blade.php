...
<html lang="en">
  ...
  <div class="row justify-content-center mt-5">
        <div class="col-md-5">
          <div class="card">
            <div class="card-header bg-transparent mb-0"><h5 class="text-center">Input Data Track</h5></div>
            <div class="card-body">
              <form action="TrackInsertProcess" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  Nama Track<br>
                  <input type="text" name="track_name" class="form-control" placeholder="Nama Track" required>
                </div>
                <div class="form-group">
                  File Track<br>
                  <input class="form-control" type="file" name="track_file" id="audioselector" required>
                </div>
                <div class="form-group">
                  Pratinjau Musik<br>
                  <audio class="form-control" id="audiosrc" controls>
