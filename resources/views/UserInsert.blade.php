...
<html lang="en">
  ...
  <div class="row justify-content-center mt-5">
        <div class="col-md-5">
          <div class="card">
            <div class="card-header bg-transparent mb-0"><h5 class="text-center">Input Data User</h5></div>
            <div class="card-body">
              <form action="UserInsertProcess" method="post">
                ...
                <div class="form-group">
                  Nickname<br>
                  <input type="text" name="user_nickname" class="form-control" placeholder="Nama User" required>
                </div>
                <div class="form-group">
